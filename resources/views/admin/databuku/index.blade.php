...
@section('container')
    <div class="container">
        ...
        <a href="{{ route('databuku.create') }}" class="btn btn-primary" style="float: right;">Tambah Buku</a>
        <table class="table">
            <thead>
                <tr>
                    <th>No</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ route('databuku.edit', $buku->id) }}" class="btn btn-warning" onclick="return confirm('Apakah Anda yakin ingin mengedit buku ini?')">Edit</a>
                        <form action="{{ route('databuku.destroy', $buku->id) }}" method="POST" style="display: inline;" onsubmit="return confirm('Apakah Anda yakin ingin menghapus buku ini?')">
                            @csrf
                            @method('DELETE')
